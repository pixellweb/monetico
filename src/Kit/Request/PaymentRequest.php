...
use PixellWeb\Monetico\Kit\Collections\ThreeDSecureChallengeValue;
use PixellWeb\Monetico\Kit\Collections\PaymentProtocol;
...
class PaymentRequest
{
    ...
    public function getFormFields()
    {
        ...
        $seal = $hmacComputer->sealFields($formFields, config('monetico.cle_mac'));
        $formFields['MAC'] = $seal;
        return $formFields;
    }
    ...
    public function getFormFieldsWithoutMac()
    {
        $formFields = [];
        // Payment terminal
        $formFields["TPE"] = config('monetico.tpe');
        $formFields["societe"] = config('monetico.code_societe');
        $formFields["lgue"] = $this->getLangue();
        $formFields["version"] = config('monetico.cle_version');
    ...
    /**
     * @return \PixellWeb\Monetico\Kit\Request\OrderContext
     */
    public function getContexteCommande(): \PixellWeb\Monetico\Kit\Request\OrderContext
    {
        return $this->contexteCommande;
    }

    /**
     * @param \PixellWeb\Monetico\Kit\Request\OrderContext $contexteCommande
     */
    public function setContexteCommande(\PixellWeb\Monetico\Kit\Request\OrderContext $contexteCommande): void
    {
    ...
    /**
     * @return \PixellWeb\Monetico\Kit\Request\CofidisPaymentInformations|null
     */
    public function getCofidis(): ?\PixellWeb\Monetico\Kit\Request\CofidisPaymentInformations
    {
        return $this->cofidis;
    }

    /**
     * @param \PixellWeb\Monetico\Kit\Request\CofidisPaymentInformations|null $cofidis
     */
    public function setCofidis(?\PixellWeb\Monetico\Kit\Request\CofidisPaymentInformations $cofidis): void
    {
